...
public class MD5 {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            String oldResourcesarsc = "/Users/hedingxu/robust-github/Robust/app/build/outputs/robust/old/resources.arsc";
            String newResourcesarsc = "/Users/hedingxu/robust-github/Robust/app/build/outputs/robust/app-release/resources.arsc";

            try {

                String oldMd5 = MD5.getHashString(new File(oldResourcesarsc));
                String newMd5 = MD5.getHashString(new File(newResourcesarsc));
                System.err.println("Resourcesarsc:");
                System.err.println("oldMd5:" + oldMd5);
            ...
            String oldmanifest = "/Users/hedingxu/robust-github/Robust/app/build/outputs/robust/old/AndroidManifest.xml";
            String newmanifest = "/Users/hedingxu/robust-github/Robust/app/build/outputs/robust/app-release/AndroidManifest.xml";

            try {

                String oldMd5 = MD5.getHashString(new File(oldmanifest));
                String newMd5 = MD5.getHashString(new File(newmanifest));
