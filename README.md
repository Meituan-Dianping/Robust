...
[![Download](https://api.bintray.com/packages/meituan/maven/com.meituan.robust%3Apatch/images/download.svg?version=0.4.98) ](https://bintray.com/meituan/maven/com.meituan.robust%3Apatch/0.4.98/link)
...
1. Add below codes in the module's build.gradle.
	...
	compile 'com.meituan.robust:robust:0.4.98'
...
2. Add below codes in the outest project's build.gradle file.
	...
	```java
	 buildscript {
	    ...
	    dependencies {
	         classpath 'com.meituan.robust:gradle-plugin:0.4.98'
	         classpath 'com.meituan.robust:auto-patch-plugin:0.4.98'
	   }
	}
	```
