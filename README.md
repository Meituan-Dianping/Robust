...
[![Download](https://api.bintray.com/packages/meituan/maven/com.meituan.robust%3Apatch/images/download.svg?version=0.4.87) ](https://bintray.com/meituan/maven/com.meituan.robust%3Apatch/0.4.87/link)
...
1. Add below codes in the module's build.gradle.
	...
	apply plugin: 'robust'
	compile 'com.meituan.robust:robust:0.4.87'
	```
